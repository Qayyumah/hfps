...
import { MdCheckCircleOutline, MdChromeReaderMode, MdPerson, MdPerson2 } from 'react-icons/md';
                ...
                <div style={{
                    ...
                    <div className='manners-text'>
                        <div className='text-text'>
                            <h1>Teaching Your Child Some Good Manners</h1>
                            <a>Take a Course</a>
                        </div>
